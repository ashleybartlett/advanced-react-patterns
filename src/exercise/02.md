...
AB - [The key to `React.cloneElement` is](https://reactjs.org/docs/react-api.html#cloneelement):
...
AB Note:
DOM elements are by convention `type === 'string'`. If it's not a string, it's a react object.

Alternatively, you can have an allow list of objects, and check for if they in that list. This method would block custom compunded components from being used. 

## 🦉 Feedback

Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=02%3A%20Compound%20Components&em=ashley.bartlett%40gmail.com).
